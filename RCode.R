...
M1 <- lm(log(wages) ~  college + university + pgraduate, data=male, weights = mw)
F1 <- lm(log(wages) ~  college + university + pgraduate, data=female, weights = fw)
M2 <- lm(log(wages) ~  BIL_MEFE + BIL_MEFF + BIL_FRENCH, data=male,weights =mw)
F2 <- lm(log(wages) ~  BIL_MEFE + BIL_MEFF + BIL_FRENCH, data=female,weights =fw)
M3 <- lm(log(wages) ~  professional + smprofessional + bluecollar, data=male, weights =mw)
F3 <- lm(log(wages) ~  professional + smprofessional + bluecollar, data=female, weights =fw)
M4 <- lm(log(wages) ~  goods + service, data=male, weights = mw)
F4 <- lm(log(wages) ~  goods + service, data=female, weights = fw)
